...
var rootCmd = &cobra.Command{
	Use:   "portfolio-data",
	Short: "Generates a whole bunch of fake data for your testing pleasure",
	RunE:  rootRunner,
}

func init() {
	rootCmd.PersistentFlags().StringP("state", "s", "state.json", "file to save state to")
	rootCmd.PersistentFlags().StringP("listen", "l", "0.0.0.0:9999", "the address to listen on")
	rootCmd.PersistentFlags().IntP("timer", "t", 1, "the frequency (in seconds) with which to generate events. 0 disables automatic generation")
